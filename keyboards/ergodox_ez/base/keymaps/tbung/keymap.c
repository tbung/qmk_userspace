...
// TODO: Maybe add some fancy stuff (smart lights, mute mic, ...) on rhs
...
[MISC] = LAYOUT_ergodox_pretty(
  ...
  _______, LCTL_T(KC_UNDO), LALT_T(KC_CUT), LGUI_T(KC_COPY), KC_PASTE,       KC_AGAIN,   _______,     _______, _______, MS_BTN1,     RGUI_T(MS_BTN3), RALT_T(MS_BTN2), MOD_RCTL, _______,
  _______, _______,         _______,        HYPR(KC_LEFT),   HYPR(KC_RIGHT),                                            HYPR(KC_UP), HYPR(KC_DOWN),   _______,         _______,  _______,
                                                                                _______, _______,     _______, _______,
                                                                                         _______,     _______,
                                                                    MO(SYSTEM), _______, _______,     _______, _______, OSM(MOD_RSFT)
),
