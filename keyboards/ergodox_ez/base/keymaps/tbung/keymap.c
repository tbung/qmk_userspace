...
[DEFAULT] = LAYOUT_ergodox_pretty(
  ...
  KC_LGUI, CTL_T(KC_Z), LALT_T(KC_X), KC_C,    KC_V,    KC_B, KC_VOLD,     MS_WHLD, KC_N, KC_M,  KC_COMM,  RALT_T(KC_DOT), CTL_T(KC_SLSH), KC_RGUI,
...
[SYMBOLS] = LAYOUT_ergodox_pretty(
  ...
  _______, KC_EXLM, KC_LCBR, KC_RCBR, KC_AT,   KC_PIPE, _______,     _______, _______, _______, _______, _______, _______, KC_F12,
